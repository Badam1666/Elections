...
def main():
    ...
    st.markdown("3. [Présentation](./pages/3%20Presentation.py) : Consultez les résultats des élections européennes de 2014 et 2019 dans votre commune, vous donnant un aperçu détaillé de la participation et des votes pour chaque parti politique.")
